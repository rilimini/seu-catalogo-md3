//código não escrito no momento, será mantida para possíveis alterações 
//verde=exclusivo do cliente, vermelho=exclusivo do adm
package Wireframes_e_Telas;

public class Wireframe_Coleção extends javax.swing.JFrame {


    public Wireframe_Coleção() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jFormattedTextField1.setBackground(new java.awt.Color(102, 0, 0));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Wireframe_Coleção().setVisible(true);
            }
        });
    }
